...
# Citation
Please cite original code for any future developments: Hughes, L. Lattice Analysis Tool (LAT). [v2.2.0] 2023; Available from: https://github.com/llywelynhughes/LAT.
